...
#    # Custom fields
    ...
    related_invoice_count = fields.Integer(string="Invoice Count", readonly=True)
    total_sales = fields.Float(string="Total Sales", readonly=True, help="Sum of related invoice amounts")
    total_profit = fields.Float(string="Total Profit", readonly=True, help="Total Sales - Bill Amount")
    profit_margin = fields.Float(string="Margin %", readonly=True, help="(Profit / Total Sales) * 100")
        ...
        self._cr.execute("""
            CREATE OR REPLACE VIEW bill_report AS (
                SELECT
                    ...
                    am.linked_activities_end_date AS linked_activities_end_date,
                    ...
                    (
                        ...
                        WHERE aml.move_id = am.id AND analytic_entry.key ~ '^[0-9]+$'
                    ) AS invoice_type,
                    (
